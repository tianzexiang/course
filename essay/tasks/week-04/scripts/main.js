...
let albums = [];
// 删除图片 路径
const deleteImgSrc = './images/delete.png';
// 加载数据
...
// 创建Area模板
function createAreaTemplate(area) {
    // 创建模板，添加事件
...
function createAlbumTemplate(album) {
    ...
    let coverImg = createEl('img', 'cover-img');
    coverImg.src = album.cover;
    let coverMask = createEl('div', 'cover-mask');
    let coverDelete = createEl('img', 'cover-delete');
